...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-649", index)
        self.assertIn("runtime-649", history)
        self.assertIn("history-74", history)
        self.assertIn('ilab-gpt-conjure-shell-v72', worker)
        self.assertIn('/static/app.js?v=runtime-649', worker)
        self.assertIn('/static/styles.css?v=runtime-649', worker)
