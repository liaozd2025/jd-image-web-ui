...
class WebUIStaticLayoutTests(WebUIStaticTestCase):
    ...
    def test_recent_reference_assets_are_rendered_and_submitted(self) -> None:
        ...
        self.assertIn('/static/app.js?v=runtime-578', html)
        self.assertIn('/static/styles.css?v=runtime-575', html)
    ...
    def test_form_controls_feature_has_typescript_source_contract(self) -> None:
        ...
        self.assertIn('form.get("size")', generation_route_source)
        self.assertIn('form.get("quality")', generation_route_source)
        self.assertIn('form.get("output_format")', generation_route_source)
    ...
    def test_output_and_auth_switchers_use_sliding_segmented_indicator(self) -> None:
        ...
        self.assertNotIn('"#systemSettingsTabs"', indicator_source)
    ...
    def test_api_provider_settings_regression_contract(self) -> None:
        ...
        self.assertIn('markSystemSettingsDirty', script)
