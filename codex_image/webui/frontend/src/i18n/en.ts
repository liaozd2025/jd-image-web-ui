...
export const EN_DICTIONARY: TranslationDictionary = {
    ...
    "history.documentTitle": "History - 九典制药图片内容生产平台",
...
"output.lock.search": "Search",
    ...
    "serverSettings.sessionMeta": "Last active {lastSeen} · expires {expires}",
    ...
    "serverSettings.storageMeta": " · storage {used} / {limit}",
    ...
    "serverSettings.quotaMeta": "Used {used} · available {available}",
    ...
    "serverSettings.sharedAssetMeta": "Publisher {publisher} · {status}",
    ...
    "serverSettings.pagination": "Page {page} of {pages} · {total} items",
    ...
    "serverSettings.schedulerUserMeta": "Queued {queued} · running {running}",
    "serverSettings.totalTasks": "Total tasks",
    "serverSettings.storageUsed": "Storage used",
    "serverSettings.createdAt": "Created {date}",
    "serverSettings.auditMeta": "{date} · actor {actor}{subject}",
    "serverSettings.auditSubject": " · subject {subject}",
    ...
    "apiSettings.validateModel": "Validate",
    "apiSettings.validatingModel": "Validating",
    "apiSettings.validateModelHint": "Run one real image request at the profile's minimum size",
    "apiSettings.saveBeforeValidation": "Save the model configuration before validating it",
    "apiSettings.validationStarting": "Starting model validation…",
    "apiSettings.validationStartFailed": "Could not start model validation",
    "apiSettings.validationQueued": "Model validation queued",
    "apiSettings.validationVerified": "Model validation succeeded",
    "apiSettings.validationFailed": "Model validation failed",
    ...
    "apiSettings.deleteProviderDetail": "This hides the provider from the catalog and workspace immediately while preserving task and audit history.",
    "apiSettings.deleteProviderStatus": "Provider deleted.",
    ...
    "apiSettings.apiKeyRequired": "Enter an API key before creating the provider.",
    ...
    "generationModel.summaryGeneric": "Basic generation · Compatibility mode",
    "generationModel.summarySeedreamLite": "Image series · Up to 4K",
    "generationModel.summarySeedreamPro": "Precise editing · Up to 2K",
