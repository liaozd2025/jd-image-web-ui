...
export const ZH_CN_DICTIONARY: TranslationDictionary = {
    ...
    "history.documentTitle": "历史库 - 九典制药图片内容生产平台",
    "history.back": "返回生成页",
    "history.title": "历史库",
    "history.loading": "载入中",
...
"output.lock.search": "搜索",
    ...
    "serverSettings.sessionMeta": "最近活动 {lastSeen} · 到期 {expires}",
    ...
    "serverSettings.storageMeta": " · 存储 {used} / {limit}",
    ...
    "serverSettings.quotaMeta": "已用 {used} · 可用 {available}",
    ...
    "serverSettings.sharedAssetMeta": "发布者 {publisher} · {status}",
    ...
    "serverSettings.pagination": "第 {page} 页，共 {pages} 页 · {total} 项",
    ...
    "serverSettings.schedulerUserMeta": "等待 {queued} · 运行 {running}",
    "serverSettings.totalTasks": "任务总数",
    "serverSettings.storageUsed": "存储已用",
    "serverSettings.createdAt": "创建于 {date}",
    "serverSettings.auditMeta": "{date} · 操作者 {actor}{subject}",
    "serverSettings.auditSubject": " · 对象 {subject}",
    ...
    "apiSettings.validateModel": "验证",
    "apiSettings.validatingModel": "验证中",
    "apiSettings.validateModelHint": "使用最小规格执行一次真实生图验证",
    "apiSettings.saveBeforeValidation": "先保存模型配置，再执行验证",
    "apiSettings.validationStarting": "正在发起模型验证…",
    "apiSettings.validationStartFailed": "无法发起模型验证",
    "apiSettings.validationQueued": "模型验证已进入队列",
    "apiSettings.validationVerified": "模型验证成功",
    "apiSettings.validationFailed": "模型验证失败",
    ...
    "apiSettings.deleteProviderDetail": "删除后会立即从供应商目录和工作台隐藏，历史任务和审计记录仍会保留。",
    "apiSettings.deleteProviderStatus": "供应商已删除",
    ...
    "apiSettings.apiKeyRequired": "新建供应商前请填写 API Key",
    ...
    "generationModel.summaryGeneric": "基础生成 · 兼容模式",
    "generationModel.summarySeedreamLite": "连续组图 · 最高 4K",
    "generationModel.summarySeedreamPro": "精准编辑 · 最高 2K",
